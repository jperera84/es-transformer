...
from example_tests_objects import generate_avg_agg_object, generate_bool_filter_object, generate_cardinality_agg_object, generate_composite_agg_object, generate_date_histogram_agg_object, generate_histogram_agg_object, generate_ids_filter_object, generate_match_filter_object, generate_max_agg_object, generate_nested_terms_agg_object, generate_range_agg_object, generate_range_filter_object, generate_sort_object, generate_sum_agg_object, generate_term_filter_object, generate_terms_agg_object, generate_terms_filter_object, generate_wildcard_filter_object
...
def home():
    ...
    query = transformer.transform(
        generate_nested_terms_agg_object()
    )
